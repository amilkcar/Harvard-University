(* NAMES:
 *
 * Partner 1's name: Amilcar Flores
 * Partner 1's code.seas account: amilcar.flores@gmail.com
 *
 * Partner 2's name: Stan Belov
 * Partner 2's code.seas account: belov.stan@gmail.com
 *)
